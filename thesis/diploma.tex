...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{Heilig Benedek}
\newcommand{\vikkonzulens}{Kundra László János}
\newcommand{\vikcim}{Modular Interpreter Written in JavaScript}
\newcommand{\viktanszek}{Department of Automation and Applied Informatics}
\newcommand{\vikdoktipus}{Degree thesis}
\newcommand{\vikdepartmentr}{Heilig Benedek}
...
\onehalfspacing
%\include{guideline}
\includepdf[pages={1}]{figures/feladat.pdf}
\include{project}
